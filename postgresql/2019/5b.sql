...
create function opcode_5(pc integer, mode_1 integer, mode_2 integer) returns void volatile language sql as $$
...
create function opcode_6(pc integer, mode_1 integer, mode_2 integer) returns void volatile language sql as $$
    select debug(format('jump to %s if %s = 0', read(pc + 2, mode_2), read(pc + 1, mode_1)));
...
create function opcode_7(pc integer, mode_1 integer, mode_2 integer, mode_3 integer) returns void volatile language sql as $$
...
create function opcode_8(pc integer, mode_1 integer, mode_2 integer, mode_3 integer) returns void volatile language sql as $$
    select debug(format('writing result of %s = %s to %s', read(pc + 1, mode_1), read(pc + 2, mode_2), read(pc + 3, 1)));
