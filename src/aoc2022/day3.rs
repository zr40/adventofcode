...
#[test]
fn a_puzzle() {
    assert_eq!(solve_a_for(&input_for(2022, 3)), 7446);
}

fn solve_a() -> PuzzleResult {
    solve_a_for(&input_for(2022, 3)).into()
}
...
#[test]
fn b_puzzle() {
    assert_eq!(solve_b_for(&input_for(2022, 3)), 2646);
}

fn solve_b() -> PuzzleResult {
    solve_b_for(&input_for(2022, 3)).into()
}
