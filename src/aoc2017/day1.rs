...
#[test]
fn a_puzzle() {
    assert_eq!(solve_a_for(&input_for(2017, 1)), 1102);
}

fn solve_a() -> PuzzleResult {
    solve_a_for(&input_for(2017, 1)).into()
}
...
#[test]
fn b_puzzle() {
    assert_eq!(solve_b_for(&input_for(2017, 1)), 1076);
}

fn solve_b() -> PuzzleResult {
    solve_b_for(&input_for(2017, 1)).into()
}
