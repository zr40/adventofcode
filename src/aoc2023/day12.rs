...
#[test]
fn a_puzzle() {
    assert_eq!(solve_for(&input_for(2023, 12), Mode::PartA), 7084);
}

fn solve_a() -> PuzzleResult {
    solve_for(&input_for(2023, 12), Mode::PartA).into()
}
...
#[test]
fn b_puzzle() {
    assert_eq!(solve_for(&input_for(2023, 12), Mode::PartB), 8414003326821);
}

fn solve_b() -> PuzzleResult {
    solve_for(&input_for(2023, 12), Mode::PartB).into()
}
